...
class Screen {
  ...
  Screen(XML screen){
    ...
    unassign();
    screenXML = screen;
    XML[] scenesXML = screenXML.getChildren("Scene");
    for (XML sceneXML : scenesXML){
      Scene newScene = new Scene(sceneXML);
      scenes.add(newScene);
    }
  }
  ...
  void addScene(int id){
    ...
    scenes.add(newScene);
    screenXML.addChild(newScene.sceneXML);
  }
  
  void addScene(XML sceneXML){
    scenes.add(new Scene(sceneXML));
    screenXML.addChild(sceneXML);
  }
